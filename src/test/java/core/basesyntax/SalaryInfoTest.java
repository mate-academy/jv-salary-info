...
public class SalaryInfoTest {
  ...
  private static final String[] dates = {"24.04.2019", "25.04.2019", "26.04.2019", "27.04.2019"};
  ...
  public void getSalaryInfoByTwoMonths() {
    SalaryInfo salary = new SalaryInfo();
    String actualResult =
        salary.getSalaryInfo(sampleNames, secondScriptArray, secondDates[0], secondDates[1]);
