...
public class SalaryInfoTest {
    ...
    public void getSalaryInfoByMonth() {
        ...
        for (int i = 0; i < dates.length; i++) {
            String actualResult = SalaryInfo.getSalaryInfo(sampleNames, scriptArray, dates[0], dates[i]);
    ...
    public void getSalaryInfoByTwoMonths() {
        SalaryInfo salary = new SalaryInfo();
        String actualResult = SalaryInfo.getSalaryInfo(sampleNames, secondScriptArray,
