        ...
        for (String name : names) {
            ...
            for (int i = 0; i < data.length; i++) {
                try {
                    ...
                    LocalDate localDate = LocalDate.parse(splitDataArray[0], dateTimeFormatter);
                    if (localDate.isAfter(localDateIsAfter)
                        ...
                        salaryFromPeriod += Integer.parseInt(splitDataArray[2])
            ...
            sbReport.append(System.lineSeparator()).append(name).append(" - ")
                    .append(salaryFromPeriod);
        }
