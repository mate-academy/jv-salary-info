    ...
    public String getSalaryInfo(String[] names, String[] data, String dateFrom, String dateTo) {
        ...
        for (String name : names) {
            ...
            for (String line : data) {
                ...
                if (name.equals(record[NAME_POSITION]) && (recordDate.isAfter(localDateFrom)
                        || recordDate.equals(localDateFrom)) && (recordDate.isBefore(localDateTo)
                        || recordDate.equals(localDateTo))) {
