...
public class SalaryInfo {
    ...
    private final String DATA_ITEMS_SEPARATOR = " ";
    private final String REPORT_DATA_SEPARATOR = " - ";
    ...
    public String getSalaryInfo(String[] names, String[] data, String dateFrom, String dateTo) {
        ...
        reportBuilder.append("Report for period ").append(dateFrom).append(REPORT_DATA_SEPARATOR).append(dateTo);
        ...
        for (String name : names) {
            ...
            reportBuilder.append(System.lineSeparator()).append(name).append(REPORT_DATA_SEPARATOR).append(salary);
        }
