...
public class SalaryInfo {
    ...
    private static String DATA_LINE_SEPARATOR = " ";
    private static int INDEX_OF_DATE = 0;
    private static int INDEX_OF_NAME = 1;
    private static int INDEX_OF_WORKING_HOURS = 2;
    private static int INDEX_OF_INCOME_PER_HOUR = 3;
    ...
    public String getSalaryInfo(String[] names, String[] data, String dateFrom, String dateTo) {
        ...
        for (String name : names) {
            ...
            for (String datum : data) {
                ...
                LocalDate currentDate = LocalDate.parse(lineFromData[INDEX_OF_DATE], formatter);
