...
public class SalaryInfo {
    ...
    public String getSalaryInfo(String[] names, String[] data, String dateFrom, String dateTo) {
        StringBuilder appender = new StringBuilder("Report for period ").append(dateFrom).append(LOG_INFO_DELIMITER).append(dateTo);
        ...
        for (String name : names) {
            ...
            appender.append(System.lineSeparator()).append(name).append(LOG_INFO_DELIMITER).append(sum);
        }
