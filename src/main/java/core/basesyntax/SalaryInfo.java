    ...
    public String getSalaryInfo(String[] names, String[] data, String dateFrom, String dateTo) {
        ...
        for (String name : names) {
            ...
            for (String line : data) {
                arraysOfData = line.split(" ");
                LocalDate current = LocalDate.parse(arraysOfData[START_WORK], FORMATTER);
                if (arraysOfData[NAME_INDEX].equals(name) && (current.isAfter(localDateFrom)
                    ...
                    salary += Integer.parseInt(arraysOfData[SALARY_FOR_HOUR])
                            * Integer.parseInt(arraysOfData[HOURS_OF_WORK]);
                }
            }
