...
public class SalaryInfo {
    private final static int INITIALIZOR = 0;
    private final static DateTimeFormatter FORMATTER = DateTimeFormatter.ofPattern("dd.MM.yyyy");
    private final static int INDEX_OF_NAME = 1;
    private final static int INDEX_OF_HOURS = 2;
    private final static int INDEX_OF_SALARY = 3;
