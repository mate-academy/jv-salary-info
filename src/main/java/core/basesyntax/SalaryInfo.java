...
public class SalaryInfo {
    private static final DateTimeFormatter
            DOT_FORMATTER = DateTimeFormatter.ofPattern("dd.MM.yyyy");
    ...
    public String getSalaryInfo(String[] names, String[] data, String dateFrom, String dateTo) {
        LocalDate fromDate = LocalDate.parse(dateFrom, DOT_FORMATTER);
        LocalDate toDate = LocalDate.parse(dateTo, DOT_FORMATTER);
        ...
        for (String name: names) {
            ...
            for (String line: data) {
                ...
                if (name.equals(splited[NAME_INDEX])) {
                    LocalDate date = LocalDate.parse(splited[DATE_INDEX], DOT_FORMATTER);
